...
def test_get_morgan_fingerprint():
    """Test the get_morgan_fingerprint method."""
    smiles = "C1=CC=CC=C1"
...
def test_tanimoto_similarity_single_mol():
    """Test the tanimoto_similarity method. with a single molecule."""
...
def test_tanimoto_similarity_multiple_mols():
    """Test the tanimoto_similarity method with multiple molecules."""
    smiles1 = [
...
def test_cluster_tanimoto():
    """Test the cluster_tanimoto method."""
    smiles = [
